...
func run() error {
	...
	handler := httpapi.NewHandler(httpapi.Deps{
		...
		// Çıkış denetimi durumu (spec 020 H4). Motorun kendi adresleri
		// fonksiyon olarak geçiyor: liste opencode'a özgü ve httpapi'nin
		// onu tanıması gerekmiyor.
		EngineHosts:    agentRunner.EngineHosts,
		EgressProxyEnv: cfg.Runner.HTTPProxy,
